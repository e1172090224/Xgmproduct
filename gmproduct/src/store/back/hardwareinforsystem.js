...
export default {
    ...
    actions: {
        getData({commit}) {
            ajax({
                url: '/infocent/projectsearch/gethardwaresysinfo',
            }).then(res => {
        ...
        DeleteData(context,multipleSelection){
            ...
            ajax({
                method: 'post',
                url: '/infocent/projectsearch/removehardwaresysinfo',
                data: selectId
            }).then(res => {
        ...
        addFormData(context,form){
            console.log(form)
            ajax({
                url: '/infocent/projectsearch/addhardwaresysinfo',
                method: 'post',
                data: form
            }).then(res => {
        ...
        updateFormData(context,form){
            ajax({
                url: '/infocent/projectsearch/changehardwaresysinfo',
                method: 'post',
                data: form,
            }).then(res => {
                if (res.data.status === 200) {
