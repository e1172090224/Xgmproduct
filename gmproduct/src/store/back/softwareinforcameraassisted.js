...
export default {
    ...
    actions: {
        getData({commit}) {
            ajax({
                url: '/infocent/projectsearch/getsoftwarecaminfo',
            }).then(res => {
        ...
        DeleteData(context,multipleSelection){
            ...
            ajax({
                method: 'post',
                url: '/infocent/projectsearch/removesoftwarecaminfo',
                data: selectId
            }).then(res => {
        ...
        addFormData(context,form){
            console.log(form)
            ajax({
                url: '/infocent/projectsearch/addsoftwarecaminfo',
                method: 'post',
                data: form
            }).then(res => {
        ...
        updateFormData(context,form){
            ajax({
                url: '/infocent/projectsearch/changesoftwarecaminfo',
                method: 'post',
                data: form,
            }).then(res => {
                if (res.data.status === 200) {
