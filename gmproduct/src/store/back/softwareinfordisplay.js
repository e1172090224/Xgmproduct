...
export default {
    ...
    actions: {
        getData({commit}) {
            ajax({
                url: '/infocent/projectsearch/getsoftwaredisinfo',
            }).then(res => {
        ...
        DeleteData(context,multipleSelection){
            ...
            ajax({
                method: 'post',
                url: '/infocent/projectsearch/removesoftwaredisinfo',
                data: selectId
            }).then(res => {
        ...
        addFormData(context,form){
            console.log(form)
            ajax({
                url: '/infocent/projectsearch/addsoftwaredisinfo',
                method: 'post',
                data: form
            }).then(res => {
        ...
        updateFormData(context,form){
            ajax({
                url: '/infocent/projectsearch/changesoftwaredisinfo',
                method: 'post',
                data: form,
            }).then(res => {
                if (res.data.status === 200) {
