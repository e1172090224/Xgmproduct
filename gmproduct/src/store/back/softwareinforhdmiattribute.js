...
export default {
    ...
    actions: {
        getData({commit}) {
            ajax({
                url: '/infocent/projectsearch/getsoftwarehdminfo',
            }).then(res => {
        ...
        DeleteData(context,multipleSelection){
            ...
            ajax({
                method: 'post',
                url: '/infocent/projectsearch/removesoftwarehdminfo',
                data: selectId
            }).then(res => {
        ...
        addFormData(context,form){
            console.log(form)
            ajax({
                url: '/infocent/projectsearch/addsoftwarehdminfo',
                method: 'post',
                data: form
            }).then(res => {
        ...
        updateFormData(context,form){
            ajax({
                url: '/infocent/projectsearch/changesoftwarehdminfo',
                method: 'post',
                data: form,
            }).then(res => {
                if (res.data.status === 200) {
