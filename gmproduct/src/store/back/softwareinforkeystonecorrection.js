...
export default {
    ...
    actions: {
        getData({commit}) {
            ajax({
                url: '/infocent/projectsearch/getsoftwarekeyinfo',
            }).then(res => {
        ...
        DeleteData(context,multipleSelection){
            ...
            ajax({
                method: 'post',
                url: '/infocent/projectsearch/removesoftwarekeyinfo',
                data: selectId
            }).then(res => {
        ...
        addFormData(context,form){
            console.log(form)
            ajax({
                url: '/infocent/projectsearch/addsoftwarekeyinfo',
                method: 'post',
                data: form
            }).then(res => {
        ...
        updateFormData(context,form){
            ajax({
                url: '/infocent/projectsearch/changesoftwarekeyinfo',
                method: 'post',
                data: form,
            }).then(res => {
                if (res.data.status === 200) {
