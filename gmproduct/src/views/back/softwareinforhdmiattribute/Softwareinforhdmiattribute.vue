...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$store.dispatch('Softwareinforhdmiattribute/getData');
        },
        computed: {
            tableData() {
                return this.$store.state.Softwareinforhdmiattribute.tableData;
            }
        },
        methods: {
            handleKeywordsInput() {
                this.$store.commit('Softwareinforhdmiattribute/searchData', this.search);
            },
            handleSelectionChange(val) {
                this.multipleSelection = val;
            },
            handleAdd() {
                this.$router.push({ path: 'softwareinforhdmiattributeadd' });
            },
            handleUpdate(row) {
                this.$router.push({
            ...
            handleDelete() {
                ...
                this.$store.dispatch('Softwareinforhdmiattribute/DeleteData', this.multipleSelection)
            },
            handleClose(){
                this.dialogVisible = false;
            }
